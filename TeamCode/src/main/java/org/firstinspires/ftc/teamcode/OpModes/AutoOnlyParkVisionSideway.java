    ...
    public void buildParking(VisionEasyOpenCV.ParkingPosition position){
        switch (startPosition) {
            case BLUE_LEFT:
                ...
                switch(position){
                    case LEFT: parkPose = new Pose2d(-38, 60, Math.toRadians(0)); break; // Location 1
                    case CENTER: parkPose = new Pose2d(-34, 34, Math.toRadians(0)); break; // Location 2
                    case RIGHT: parkPose = new Pose2d(-38, 11, Math.toRadians(0)); break; // Location 3
                }
                break;
            case BLUE_RIGHT:
                initPose = new Pose2d(-68, -36, Math.toRadians(0));//Starting pose
                midWayPose = new Pose2d(-38, -36, Math.toRadians(0)); //Choose the pose to move forward towards signal cone
                switch(position){
                    case LEFT: parkPose = new Pose2d(-38, -11, Math.toRadians(0)); break; // Location 1
                    case CENTER: parkPose = new Pose2d(-34, -34, Math.toRadians(0)); break; // Location 2
                    case RIGHT: parkPose = new Pose2d(-38, -60, Math.toRadians(0)); break; // Location 3
                }
                break;
            case RED_LEFT:
                ...
                switch(position){
                    case LEFT: parkPose = new Pose2d(38, -60, Math.toRadians(180)); break; // Location 1
                    case CENTER: parkPose = new Pose2d(34, -34, Math.toRadians(180)); break; // Location 2
                    case RIGHT: parkPose = new Pose2d(38, -11, Math.toRadians(180)); break; // Location 3
                }
                break;
            case RED_RIGHT:
                initPose = new Pose2d(68, 36, Math.toRadians(180)); //Starting pose
                midWayPose = new Pose2d(38, 36, Math.toRadians(180)); //Choose the pose to move forward towards signal cone
                switch(position){
                    case LEFT: parkPose = new Pose2d(38, 11, Math.toRadians(180)); break; // Location 1
                    case CENTER: parkPose = new Pose2d(34, 34, Math.toRadians(180)); break; // Location 2
                    case RIGHT: parkPose = new Pose2d(38, 60, Math.toRadians(180)); break; // Location 3
                }
                break;
        }
